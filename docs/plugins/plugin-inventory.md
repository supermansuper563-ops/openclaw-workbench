...
- **[workbench-guardrails](/plugins/reference/workbench-guardrails)** (`@openclaw/workbench-guardrails`) - included in OpenClaw. Safety profiles, native approvals, and a redacted SQLite-backed execution journal.
