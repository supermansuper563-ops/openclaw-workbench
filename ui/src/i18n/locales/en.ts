...
export const en: TranslationMap = {
  ...
  workbench: {
    subtitle: "Set up, verify, protect, and operate OpenClaw from one place.",
    views: {
    ...
    errors: {
      gatewayRequired: "Connect to the OpenClaw Gateway before running this check.",
      journalAdminRequired: "Administrator access is required to clear the Guardrails journal.",
      gatewayReconnectForFoundation:
        "Reconnect to the Gateway before changing the Workbench foundation.",
      foundationSaveFailed:
        "The plugins were enabled, but their Workbench configuration could not be saved.",
      workboardReconnectRequired: "Enable Workboard and reconnect before creating a mission.",
      missionTitleShort: "Give the mission a title with at least three characters.",
      missionTitleLong: "Mission titles must be 240 characters or fewer.",
      missionNotesLong: "Mission notes must be 8,000 characters or fewer.",
      invalidMissionResult: "Workboard returned an invalid mission result.",
    },
    readiness: {
      gatewayTitle: "Gateway connection",
      gatewayReady: "Live handshake confirmed by this browser.",
      gatewayBlocked: "No live Gateway connection. Open connection settings to reconnect.",
      modelTitle: "Model response",
      modelConfigured: "A model is configured, but it has not been tested in this session.",
      modelMissing: "No default or agent model is configured yet.",
      channelTitle: "Channel delivery",
      channelReady: "{count} channel account(s) report a live connection.",
      channelConfigured: "A channel is configured, but none currently report a live connection.",
      channelMissing: "No messaging channel is configured. This is optional for browser-only use.",
      channelDisconnected: "Reconnect to the Gateway before relying on channel status.",
      channelChecking: "Checking channel status on the current Gateway…",
      channelError: "The latest channel check failed. Open Channels for diagnostic details.",
      channelStale: "Channel status has not been confirmed on this Gateway yet.",
      guardrailsTitle: "Guardrails runtime",
      guardrailsReady: "The Guardrails plugin is responding with the {profile} profile.",
      guardrailsDegraded: "Guardrails are configured, but the runtime method is not responding.",
      guardrailsMissing: "Guardrails are not enabled. Select a policy before risky work.",
    },
    overview: {
      kicker: "Mission control",
      heading: "Make OpenClaw useful in a few deliberate steps.",
      intro:
        "Workbench connects setup to real evidence: a live Gateway, a responding model, channel health, and an active safety policy. Then it turns an idea into a durable Workboard mission.",
      startSetup: "Start guided setup",
      createMission: "Create a mission",
      readinessLabel: "Verified readiness",
      readinessSummary: "{ready} of {total} checks currently pass",
      readinessDisclosure:
        "This is an operational check, not a security audit or guarantee that every provider action will succeed.",
      healthKicker: "Evidence, not guesses",
      healthHeading: "Live system checks",
      healthBody:
        "Configured and working are different states. Run the checks to see what this Gateway can actually reach now.",
      runChecks: "Run all checks",
      operateKicker: "Operating surfaces",
      operateHeading: "Go from setup to useful work",
      operateBody:
        "Open the native OpenClaw tools for planning, execution, approvals, knowledge, automation, and delivery.",
    },
    capabilities: {
      workboard: {
        title: "Workboard",
        body: "Plan missions as cards, assign agents, dispatch work, and review evidence.",
      },
      tasks: {
        title: "Durable tasks",
        body: "Follow background runs, retries, cancellations, and delivery status.",
      },
      automations: {
        title: "Automations",
        body: "Schedule recurring jobs and inspect their latest outcomes.",
      },
      approvals: {
        title: "Approvals",
        body: "Review pending high-impact actions before they are allowed to continue.",
      },
      memory: {
        title: "Memory",
        body: "Search and maintain the long-lived context available to your agents.",
      },
      channels: {
        title: "Channels",
        body: "Configure messaging accounts and inspect their current runtime state.",
      },
    },
    setup: {
      kicker: "First-run wizard",
      heading: "Set up the parts that make work possible.",
      intro:
        "Each step uses the OpenClaw surface that owns the setting, then returns here for a live check.",
      ...
      gateway: {
        kicker: "Step 01 · Connection",
        title: "Confirm the Gateway handshake.",
        body: "Workbench needs a live, authenticated Gateway connection before it can test models or change configuration.",
        connected: "Gateway connected",
        disconnected: "Gateway not connected",
        evidence: "Status comes from this browser's current Gateway session.",
        action: "Open connection settings",
      },
      model: {
        kicker: "Step 02 · Intelligence",
        title: "Choose a model, then make it answer.",
        body: "Use the model setup wizard for provider credentials and defaults. The check below asks the Gateway for a real model response.",
        localTitle: "Run a local open-weight model",
        localBody:
          "Ollama, LM Studio, and vLLM use OpenClaw's existing provider setup. Start the local server, open Model setup, choose its model, then verify it here.",
        phase: {
          idle: "Not tested yet",
          checking: "Request in progress",
          ready: "Model responded",
          attention: "Model needs attention",
          error: "Check failed",
        },
        verifyHelp: "No prompt text or provider secret is displayed or stored by Workbench.",
        answered: "{model} answered in {latency} ms.",
        verify: "Verify model",
        verifying: "Verifying…",
        configure: "Open model setup",
        gatewayRequired: "Reconnect to the Gateway before verifying the model.",
        adminRequired: "Administrator access is required to run a model verification.",
        methodUnavailable:
          "This Gateway does not advertise model verification. Update or reconnect it, or use Model setup.",
      },
      channel: {
        kicker: "Step 03 · Delivery",
        title: "Connect OpenClaw where you already communicate.",
        body: "Channels are optional for browser-only work. If you add one, probe its runtime state before relying on message delivery.",
        configured: "Configured",
        running: "Running",
        connected: "Connected",
        liveSummary: "{count} account(s) currently report a running or connected state.",
        configuredSummary:
          "Configuration exists, but no account reports a live state. Open Channels to diagnose it.",
        emptySummary: "No channel is configured. You can continue and use the browser interface.",
        probe: "Probe channels",
        probing: "Probing…",
        manage: "Manage channels",
      },
      safety: {
        kicker: "Step 04 · Boundaries",
        title: "Choose what requires a human decision.",
        body: "Enable Workbench Guardrails, select an operating profile, and set how long an approval remains valid.",
        adminRequired:
          "An operator with administrator access must apply plugin and configuration changes.",
      },
      finish: {
        kicker: "Step 05 · Review",
        title: "Know what is ready before the first mission.",
        body: "Open any row to fix it. A channel may remain optional, but a Gateway, working model, and active guardrails are the recommended foundation.",
        complete: "Return to overview",
        continue: "Continue with these results",
      },
    },
    profiles: {
      "personal-safe": {
        title: "Personal safe",
        summary: "A cautious default for everyday assistant work.",
        approval: "Unknown, destructive, and publishing actions require approval.",
      },
      coding: {
        title: "Coding",
        summary: "Allows routine source changes while keeping high-impact gates.",
        approval: "Deletion, publishing, and unclassified actions still require approval.",
      },
      "research-only": {
        title: "Research only",
        summary: "Restricts operation to reading and low-impact research actions.",
        approval: "Unknown actions are blocked; mutation is tightly constrained.",
      },
      "high-autonomy": {
        title: "High autonomy",
        summary: "Fewer interruptions for an isolated, trusted environment.",
        approval: "Deletion, publishing, and unknown actions remain mandatory approval gates.",
      },
    },
    safety: {
      kicker: "Runtime policy",
      heading: "See and change the boundaries around agent work.",
      intro:
        "Profiles are enforced by the bundled Guardrails plugin. Runtime status and the local redacted journal are read from the connected Gateway.",
      profilesHeading: "Approval profile",
      profilesBody: "Pick a starting policy. You can refine plugin rules later in configuration.",
      adminRequired: "Administrator access is required to change Guardrails configuration.",
      profileLabel: "Guardrails profile",
      expiryLabel: "Approval lifetime",
      expiryHelp: "Expired approval tokens cannot authorize a later action.",
      expiry15: "15 minutes",
      expiry30: "30 minutes",
      expiry60: "1 hour",
      expiry240: "4 hours",
      expiry1440: "24 hours",
      expiryCustom: "Custom · {minutes} minutes",
      apply: "Apply safety foundation",
      applying: "Applying…",
      applyingDetail: "Enabling Workboard and Guardrails, then applying the selected policy.",
      appliedRestarting:
        "Configuration applied. The Gateway is restarting; checks will resume after reconnect.",
      appliedRestartRequired:
        "Configuration was saved. Reconnect or restart the Gateway, then check runtime status.",
      foundationNote: "Configure the OpenClaw Workbench safety foundation",
      restartDisclosure: "Applying plugin changes can briefly restart or disconnect the Gateway.",
      runtime: {
        kicker: "Runtime evidence",
        heading: "Guardrails health",
        check: "Check runtime",
        idleDetail: "Runtime status has not been checked in this session.",
        loadingDetail: "Waiting for the Guardrails runtime response…",
        activeDetail: "{profile} is active. The journal currently contains {count} event(s).",
        unregisteredDetail: "The active Gateway did not register the Workbench Guardrails policy.",
        inactiveDetail: "Guardrails is configured but did not report an active runtime.",
        phase: {
          idle: "Not checked",
          loading: "Checking",
          active: "Active",
      ...
      journal: {
        ...
        body: "Recent policy decisions, approvals, and outcomes. Sensitive-looking values are redacted before storage.",
        refresh: "Refresh",
        refreshing: "Refreshing…",
        clear: "Clear journal",
        clearConfirm:
          "Clear the local Workbench Guardrails decision journal? This cannot be undone.",
        emptyTitle: "No journal events yet",
        emptyBody: "Events appear after Guardrails evaluates tool work on this Gateway.",
        toolTitle: "Tool: {tool}",
        redactedDetail: "Details are intentionally limited in this view.",
        type: {
          decision: "Decision",
          approval: "Approval",
          outcome: "Outcome",
      ...
      boundaries: {
        ...
        heading: "What Guardrails does—and does not—do",
        notSandbox: "It is a policy gate, not an operating-system sandbox.",
        unknown:
          "Unknown, delete, and publish effects cannot be made silent by a custom allow rule.",
        operator: "Gateway roles still control who can read, change, or clear policy state.",
        separateGateways:
          "Use separate Gateway instances for workloads that require hard isolation.",
      },
    },
    mission: {
      kicker: "Useful work",
      heading: "Turn an outcome into a durable mission.",
      intro:
        "Create a real Workboard card with an owner, priority, and context. Review it on the board before dispatching agent work.",
      mode: "Creates a Workboard card",
      titleLabel: "Mission outcome",
      titlePlaceholder: "Example: Prepare a verified launch checklist",
      notesLabel: "Context and acceptance criteria",
      notesHelp: "Include constraints, evidence required, and what “done” means.",
      notesPlaceholder:
        "Describe the work, important boundaries, and the proof that should accompany completion.",
      agentLabel: "Initial owner",
      ...
      workboardRequired: "Workboard is not available",
      workboardRequiredBody:
        "Enable the Workbench foundation, reconnect after the plugin change, then return here.",
      enableWorkboard: "Open safety setup",
      reviewTitle: "Create first, dispatch deliberately",
      reviewBody: "This saves the mission to Workboard. It does not silently start an agent run.",
      create: "Create mission",
      creating: "Creating…",
      creatingDetail: "Saving the mission as a Workboard card.",
      createdMessage: "Mission created. Open Workboard to review or dispatch it.",
      previewKicker: "Live preview",
      previewUntitled: "Untitled mission",
      previewEmpty: "Add context and acceptance criteria to make this mission actionable.",
      previewAgent: "Owner",
      previewPriority: "Priority",
      previewDestination: "Destination",
      previewWorkboard: "Workboard inbox",
      createdTitle: "Mission saved",
